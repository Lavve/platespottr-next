  ...
  return (
    ...
    >
      ...
      <Paper sx={{ p: 4, borderRadius: 3 }}>
        ...
        <Typography sx={{ mb: 3 }}>Senast uppdaterad: {new Date().toLocaleDateString('sv-SE')}</Typography>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          <section>
            ...
            <Typography sx={{ mb: 2 }}>Vi använder din information för att:</Typography>
            <Box component='ul' sx={{ pl: 3, mb: 2 }}>
              <Typography component='li' sx={{ mb: 1 }}>
          ...
          <section>
            ...
            <Typography sx={{ mb: 2 }}>Vi delar inte din personliga information med tredje part, förutom:</Typography>
            <Box component='ul' sx={{ pl: 3, mb: 2 }}>
              <Typography component='li' sx={{ mb: 1 }}>
          ...
          <section>
            ...
            <Typography sx={{ mb: 2 }}>Enligt GDPR har du rätt att:</Typography>
            <Box component='ul' sx={{ pl: 3, mb: 2 }}>
              <Typography component='li' sx={{ mb: 1 }}>
          ...
          <section>
            ...
            <Typography sx={{ mb: 2, fontStyle: 'italic' }}>E-post: magnus.claesson+platespottr@gmail.com</Typography>
          </section>
